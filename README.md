...
Алгоритм обнаружения заклёпок на конвейерной ленте, разработанный для ПЛК Siemens S7-1500 в среде TIA Portal v16.

## Обзор

Проект реализует программное решение для обнаружения заклёпок на конвейерной ленте для их игнорирования металлодетектором. Система разработана для ПЛК Siemens S7-1500 в среде TIA Portal.
